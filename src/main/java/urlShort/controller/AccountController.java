...
public class AccountController {
    ...
    public ResponseEntity<AccountResult> createAccount(@RequestBody AccountData accountData) {
        ...
        return new ResponseEntity<AccountResult>(accountResult, HttpStatus.OK);
    }
}
